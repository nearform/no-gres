...
test('client', t => {
  t.test('expect fails when supplied params are not an array', t => {
    const client = new NoGres.Client()
    t.throws(() => { client.expect('foo', 'bar') }, Error('Unexpected params: "bar".  Should be an array.'))
    t.end()
  })

  t.test('expect returns the generated expectation', t => {
    const client = new NoGres.Client()
  ...
  t.test('expect throws the provided error', t => {
    const client = new NoGres.Client()
  ...
  t.test('expect throws an error if not all expectations are met', t => {
    const client = new NoGres.Client()
  ...
  t.test('release noop since no-gres has a single client per pool', t => {
    const client = new NoGres.Client()
    client.release()
    t.ok(true)
    t.end()
  ...
  t.test('reset removes all pending expectations', t => {
    const client = new NoGres.Client()
    client.expect('foo', ['bar'], [{ name: 'fooRow' }, { name: 'barRow' }])
    client.expect('foo', ['bar'], [{ name: 'fooRow' }, { name: 'barRow' }])
    client.reset()
  ...
  t.test('connect throws configured error on connect: callback', t => {
    const client = new NoGres.Client()
  ...
  t.test('connect throws configured error on connect: promise', t => {
    const client = new NoGres.Client()
    client.errorOnConnect('foo')
  ...
  t.test('connect throws configured error on connect: await', async t => {
    const client = new NoGres.Client()
    client.errorOnConnect('foo')
    try {
  ...
  t.test('connect works with a callback', t => {
    const client = new NoGres.Client()
    client.connect(err => {
  ...
  t.test('connect works with promises', t => {
    const client = new NoGres.Client()
    t.resolves(client.connect())
    t.end()
  })

  t.test('connect works with await', { plan: 1 }, async t => {
    const client = new NoGres.Client()
    try {
      await client.connect()
    } catch (err) {
  ...
  t.test('query fails when not connected', t => {
    t.plan(2)
    const client = new NoGres.Client()
  ...
  t.test('query fails when no more expectations are defined', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
    const sql = 'select * from orders where id = $1'
  ...
  t.test('query fails when an unexpected sql is supplied', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query fails when an unexpected sql is supplied for regex expectation', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query fails when parameters do not match', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query fails when parameters have a different length', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
    const { sql, params } = client.expect('select * from orders where id = $1', [2, 3, 4])
  ...
  t.test('query returns an empty rowset when no return value is supplied', async t => {
    t.plan(3)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query returns the correct rowset when expected', async t => {
    t.plan(5)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query ignores the query parameters if the expectation params are null', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query correctly matches an empty array of params', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query correctly matches a nested array of params', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query correctly fails to match a nested array of params', async t => {
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query does not match an empty array of params to null', async t => {
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query works with config parameter', async t => {
    t.plan(5)
    const client = new NoGres.Client()
    await client.connect()
    const { sql, params, returns } = client.expect('select * from orders where id = $1', [1, 2, 3], [{ name: 'foo' }, { name: 'bar' }])
  ...
  t.test('query handles multiple exptectations in the correct order', async t => {
    t.plan(4)
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('query throws error when provided', async t => {
    const client = new NoGres.Client()
    await client.connect()
  ...
  t.test('events can be used to manually simulate events', async t => {
    t.plan(2)
    const client = new NoGres.Client()
    await client.connect()
...
test('pool', t => {
  ...
  t.test('connect passes through underlying client error: callback', t => {
    t.plan(3)
    const pool = new NoGres.Pool()
  ...
  t.test('connect passes through underlying client error', async t => {
    t.plan(2)
    const pool = new NoGres.Pool()
    pool.client.errorOnConnect(new Error('bar'))
  ...
  t.test('reset clears the expectations set', async t => {
    t.plan(2)
    const pool = new NoGres.Pool()
  ...
  t.test('end invokes suppled callback', async t => {
    const pool = new NoGres.Pool()
    pool.end(() => { t.ok(true) })
    t.end()
  })
